using Maestro.DeviceManagement.Application.Commands;
using Maestro.DeviceManagement.Application.Queries;
using Maestro.DeviceManagement.Domain.Repositories;
using Maestro.DeviceManagement.Domain.Services;
using Maestro.DeviceManagement.Domain.Factories;
using Maestro.DeviceManagement.Infrastructure.Communication;
using Maestro.DeviceManagement.Infrastructure.Communication.Snmp;
using Maestro.DeviceManagement.Infrastructure.Communication.Acl;
using Maestro.DeviceManagement.Infrastructure.Persistence;
using Maestro.DeviceManagement.Infrastructure.Persistence.Repositories;
using Maestro.DeviceManagement.Infrastructure.Messaging.Consumers;
using Maestro.Shared.Infrastructure.Commands;
using Maestro.Shared.Api.Queries;
using Maestro.Shared.Domain;
using Maestro.Shared.Infrastructure.Configuration;
using Maestro.Shared.Infrastructure.Messaging;
using Maestro.Shared.Infrastructure.Persistence;
using Maestro.Shared.Presentation.Configuration;
...
builder.Services.AddDbContext<DeviceManagementDbContext>(options =>
    options.UseNpgsql(
        ...
        npgsqlOptions => npgsqlOptions.MigrationsAssembly("maestro.device-management.infrastructure")));
...
app.UseSharedPresentation(); // Adds logging and exception handling middleware
